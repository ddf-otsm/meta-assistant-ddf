...
export default function ProjectPage() {
  ...
  const createModel = useMutation({
    mutationFn: async (modelData: { name: string, projectId: number, definition: ApiSpecification }) => {
  ...
  const isLoading = isLoadingProject || isLoadingModels || isLoadingConversation || isLoadingGeneratedCode;
