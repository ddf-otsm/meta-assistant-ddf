    ...
    <header className="bg-background border-b border-border sticky top-0 z-50">
      <div className="container mx-auto px-4 flex items-center justify-between h-16">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <Link href="/templates">
            <a className="text-muted-foreground hover:text-primary font-medium transition">Templates</a>
          </Link>
          <Link href="/docs">
            <a className="text-muted-foreground hover:text-primary font-medium transition">Documentation</a>
          </Link>
        </nav>
